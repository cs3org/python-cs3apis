...
_ISINGROUPRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='groups', full_name='cs3.userproviderv0alpha.IsInGroupResponse.groups', index=2,
      number=3, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETUSERREQUEST.fields_by_name['user_id'].message_type = cs3_dot_auth_dot_v0alpha_dot_resources__pb2._USER
...
_GETUSERGROUPSREQUEST.fields_by_name['user_id'].message_type = cs3_dot_auth_dot_v0alpha_dot_resources__pb2._USER
...
_ISINGROUPREQUEST.fields_by_name['user_id'].message_type = cs3_dot_auth_dot_v0alpha_dot_resources__pb2._USER
