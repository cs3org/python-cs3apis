...
_RESOURCEINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='canonical_metadata', full_name='cs3.storage.provider.v1beta1.ResourceInfo.canonical_metadata', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='arbitrary_metadata', full_name='cs3.storage.provider.v1beta1.ResourceInfo.arbitrary_metadata', index=12,
