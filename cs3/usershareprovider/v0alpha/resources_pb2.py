...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='cs3/usershareprovider/v0alpha/resources.proto',
  package='cs3.usershareproviderv0alpha',
  syntax='proto3',
  serialized_options=_b('\n com.cs3.usershareproviderv0alphaB\016ResourcesProtoP\001Z\032usershareproviderv0alphapb\242\002\025CBOXUSERSHAREPROVIDER\252\002\034CS3.UserShareProviderV0Alpha\312\002\034CS3\\UserShareProviderV0Alpha'),
  serialized_pb=_b('\n-cs3/usershareprovider/v0alpha/resources.proto\x12\x1c\x63s3.usershareproviderv0alpha\x1a+cs3/storageprovider/v0alpha/resources.proto\x1a\x15\x63s3/types/types.proto\"\x82\x03\n\x05Share\x12\x31\n\x02id\x18\x01 \x01(\x0b\x32%.cs3.usershareproviderv0alpha.ShareId\x12;\n\x0bresource_id\x18\x02 \x01(\x0b\x32&.cs3.storageproviderv0alpha.ResourceId\x12\x43\n\x0bpermissions\x18\x03 \x01(\x0b\x32..cs3.usershareproviderv0alpha.SharePermissions\x12\x34\n\x07grantee\x18\x04 \x01(\x0b\x32#.cs3.storageproviderv0alpha.Grantee\x12 \n\x05owner\x18\x05 \x01(\x0b\x32\x11.cs3.types.UserId\x12\"\n\x07\x63reator\x18\x06 \x01(\x0b\x32\x11.cs3.types.UserId\x12#\n\x05\x63time\x18\x07 \x01(\x0b\x32\x14.cs3.types.Timestamp\x12#\n\x05mtime\x18\x08 \x01(\x0b\x32\x14.cs3.types.Timestamp\"X\n\x10SharePermissions\x12\x44\n\x0bpermissions\x18\x01 \x01(\x0b\x32/.cs3.storageproviderv0alpha.ResourcePermissions\"|\n\rReceivedShare\x12\x32\n\x05share\x18\x01 \x01(\x0b\x32#.cs3.usershareproviderv0alpha.Share\x12\x37\n\x05state\x18\x02 \x01(\x0e\x32(.cs3.usershareproviderv0alpha.ShareState\"\x9f\x01\n\x08ShareKey\x12 \n\x05owner\x18\x02 \x01(\x0b\x32\x11.cs3.types.UserId\x12;\n\x0bresource_id\x18\x03 \x01(\x0b\x32&.cs3.storageproviderv0alpha.ResourceId\x12\x34\n\x07grantee\x18\x04 \x01(\x0b\x32#.cs3.storageproviderv0alpha.Grantee\"\x1c\n\x07ShareId\x12\x11\n\topaque_id\x18\x02 \x01(\t\"\x84\x01\n\x0eShareReference\x12\x33\n\x02id\x18\x01 \x01(\x0b\x32%.cs3.usershareproviderv0alpha.ShareIdH\x00\x12\x35\n\x03key\x18\x02 \x01(\x0b\x32&.cs3.usershareproviderv0alpha.ShareKeyH\x00\x42\x06\n\x04spec\"\x87\x01\n\nShareGrant\x12\x34\n\x07grantee\x18\x01 \x01(\x0b\x32#.cs3.storageproviderv0alpha.Grantee\x12\x43\n\x0bpermissions\x18\x02 \x01(\x0b\x32..cs3.usershareproviderv0alpha.SharePermissions*r\n\nShareState\x12\x17\n\x13SHARE_STATE_INVALID\x10\x00\x12\x17\n\x13SHARE_STATE_PENDING\x10\x01\x12\x18\n\x14SHARE_STATE_ACCEPTED\x10\x02\x12\x18\n\x14SHARE_STATE_REJECTED\x10\x03\x42\xa6\x01\n com.cs3.usershareproviderv0alphaB\x0eResourcesProtoP\x01Z\x1ausershareproviderv0alphapb\xa2\x02\x15\x43\x42OXUSERSHAREPROVIDER\xaa\x02\x1c\x43S3.UserShareProviderV0Alpha\xca\x02\x1c\x43S3\\UserShareProviderV0Alphab\x06proto3')
  ,
...
_SHARESTATE = _descriptor.EnumDescriptor(
  name='ShareState',
  full_name='cs3.usershareproviderv0alpha.ShareState',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_SHARE = _descriptor.Descriptor(
  name='Share',
  full_name='cs3.usershareproviderv0alpha.Share',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='cs3.usershareproviderv0alpha.Share.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='resource_id', full_name='cs3.usershareproviderv0alpha.Share.resource_id', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='permissions', full_name='cs3.usershareproviderv0alpha.Share.permissions', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='grantee', full_name='cs3.usershareproviderv0alpha.Share.grantee', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='owner', full_name='cs3.usershareproviderv0alpha.Share.owner', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='creator', full_name='cs3.usershareproviderv0alpha.Share.creator', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ctime', full_name='cs3.usershareproviderv0alpha.Share.ctime', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mtime', full_name='cs3.usershareproviderv0alpha.Share.mtime', index=7,
...
_SHAREPERMISSIONS = _descriptor.Descriptor(
  ...
  full_name='cs3.usershareproviderv0alpha.SharePermissions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='permissions', full_name='cs3.usershareproviderv0alpha.SharePermissions.permissions', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RECEIVEDSHARE = _descriptor.Descriptor(
  name='ReceivedShare',
  full_name='cs3.usershareproviderv0alpha.ReceivedShare',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='share', full_name='cs3.usershareproviderv0alpha.ReceivedShare.share', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='state', full_name='cs3.usershareproviderv0alpha.ReceivedShare.state', index=1,
...
_SHAREKEY = _descriptor.Descriptor(
  name='ShareKey',
  full_name='cs3.usershareproviderv0alpha.ShareKey',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='owner', full_name='cs3.usershareproviderv0alpha.ShareKey.owner', index=0,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='resource_id', full_name='cs3.usershareproviderv0alpha.ShareKey.resource_id', index=1,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='grantee', full_name='cs3.usershareproviderv0alpha.ShareKey.grantee', index=2,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SHAREID = _descriptor.Descriptor(
  name='ShareId',
  full_name='cs3.usershareproviderv0alpha.ShareId',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='opaque_id', full_name='cs3.usershareproviderv0alpha.ShareId.opaque_id', index=0,
...
_SHAREREFERENCE = _descriptor.Descriptor(
  name='ShareReference',
  full_name='cs3.usershareproviderv0alpha.ShareReference',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='cs3.usershareproviderv0alpha.ShareReference.id', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='key', full_name='cs3.usershareproviderv0alpha.ShareReference.key', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='spec', full_name='cs3.usershareproviderv0alpha.ShareReference.spec',
...
_SHAREGRANT = _descriptor.Descriptor(
  name='ShareGrant',
  full_name='cs3.usershareproviderv0alpha.ShareGrant',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='grantee', full_name='cs3.usershareproviderv0alpha.ShareGrant.grantee', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='permissions', full_name='cs3.usershareproviderv0alpha.ShareGrant.permissions', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
Share = _reflection.GeneratedProtocolMessageType('Share', (_message.Message,), {
  'DESCRIPTOR' : _SHARE,
  '__module__' : 'cs3.usershareprovider.v0alpha.resources_pb2'
  # @@protoc_insertion_point(class_scope:cs3.usershareproviderv0alpha.Share)
  })
...
SharePermissions = _reflection.GeneratedProtocolMessageType('SharePermissions', (_message.Message,), {
  ...
  '__module__' : 'cs3.usershareprovider.v0alpha.resources_pb2'
  # @@protoc_insertion_point(class_scope:cs3.usershareproviderv0alpha.SharePermissions)
  })
...
ReceivedShare = _reflection.GeneratedProtocolMessageType('ReceivedShare', (_message.Message,), {
  ...
  '__module__' : 'cs3.usershareprovider.v0alpha.resources_pb2'
  # @@protoc_insertion_point(class_scope:cs3.usershareproviderv0alpha.ReceivedShare)
  })
...
ShareKey = _reflection.GeneratedProtocolMessageType('ShareKey', (_message.Message,), {
  ...
  '__module__' : 'cs3.usershareprovider.v0alpha.resources_pb2'
  # @@protoc_insertion_point(class_scope:cs3.usershareproviderv0alpha.ShareKey)
  })
...
ShareId = _reflection.GeneratedProtocolMessageType('ShareId', (_message.Message,), {
  'DESCRIPTOR' : _SHAREID,
  '__module__' : 'cs3.usershareprovider.v0alpha.resources_pb2'
  # @@protoc_insertion_point(class_scope:cs3.usershareproviderv0alpha.ShareId)
  })
...
ShareReference = _reflection.GeneratedProtocolMessageType('ShareReference', (_message.Message,), {
  ...
  '__module__' : 'cs3.usershareprovider.v0alpha.resources_pb2'
  # @@protoc_insertion_point(class_scope:cs3.usershareproviderv0alpha.ShareReference)
  })
...
ShareGrant = _reflection.GeneratedProtocolMessageType('ShareGrant', (_message.Message,), {
  ...
  '__module__' : 'cs3.usershareprovider.v0alpha.resources_pb2'
  # @@protoc_insertion_point(class_scope:cs3.usershareproviderv0alpha.ShareGrant)
  })
