...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='cs3/invite/v1beta1/resources.proto',
  package='cs3.invite.v1beta1',
  syntax='proto3',
  serialized_options=_b('\n\026com.cs3.invite.v1beta1B\016ResourcesProtoP\001Z\rinvitev1beta1\242\002\003CIX\252\002\022Cs3.Invite.V1Beta1\312\002\022Cs3\\Invite\\V1Beta1'),
  serialized_pb=_b('\n\"cs3/invite/v1beta1/resources.proto\x12\x12\x63s3.invite.v1beta1\x1a)cs3/identity/user/v1beta1/resources.proto\x1a,cs3/storage/provider/v1beta1/resources.proto\x1a\x1d\x63s3/types/v1beta1/types.proto\"\x82\x01\n\x0bInviteToken\x12\r\n\x05token\x18\x01 \x01(\t\x12\x32\n\x07user_id\x18\x02 \x01(\x0b\x32!.cs3.identity.user.v1beta1.UserId\x12\x30\n\nexpiration\x18\x03 \x01(\x0b\x32\x1c.cs3.types.v1beta1.TimestampBi\n\x16\x63om.cs3.invite.v1beta1B\x0eResourcesProtoP\x01Z\rinvitev1beta1\xa2\x02\x03\x43IX\xaa\x02\x12\x43s3.Invite.V1Beta1\xca\x02\x12\x43s3\\Invite\\V1Beta1b\x06proto3')
  ,
...
_INVITETOKEN = _descriptor.Descriptor(
  name='InviteToken',
  full_name='cs3.invite.v1beta1.InviteToken',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='token', full_name='cs3.invite.v1beta1.InviteToken.token', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='user_id', full_name='cs3.invite.v1beta1.InviteToken.user_id', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='expiration', full_name='cs3.invite.v1beta1.InviteToken.expiration', index=2,
...
InviteToken = _reflection.GeneratedProtocolMessageType('InviteToken', (_message.Message,), {
  ...
  '__module__' : 'cs3.invite.v1beta1.resources_pb2'
  # @@protoc_insertion_point(class_scope:cs3.invite.v1beta1.InviteToken)
  })
